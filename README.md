...
| ES | [BiteQ](https://github.com/Juliosantos04/ES) |This project aimed to create a terminal application to analyze, visualize, and manage staff and table schedules within a restaurant setting.| 17.40 | Dart, FlutterSDK, Firebase |
| LTW | [Smartphone Shop](https://github.com/Juliosantos04/ES) |This project aimed to build an online platform for buying and selling used smartphones.| 15.50 | HTML, CSS, PHP, Javascript, SQL |
